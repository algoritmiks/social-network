...
const Dialogs = (props) => {
    ...
    let conversationsElems = props.conversations.map(name => <DialogItem id={name.id} name={name.name} />);
    
    let messagesElements = props.messages.map(message => <Message msg={message.msg} />)
